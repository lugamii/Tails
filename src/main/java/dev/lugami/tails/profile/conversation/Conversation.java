package dev.lugami.tails.profile.conversation;
...
public class Conversation {
	...
	public void sendMessage(Player sender, Player target, String message) {
		sender.sendMessage(Locale.CONVERSATION_SEND_MESSAGE.format(
				sender.getName(), sender.getDisplayName(), TailsAPI.getColorOfPlayer(sender),
				target.getName(), target.getDisplayName(), TailsAPI.getColorOfPlayer(target))
				.replace("%MSG%", message));
