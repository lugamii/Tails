package dev.lugami.tails.profile.punishment.menu;

import dev.lugami.tails.cache.RedisPlayerData;
import dev.lugami.tails.profile.Profile;
import dev.lugami.tails.profile.menu.ProfileMenuControlHeaderButton;
...
import dev.lugami.tails.util.menu.pagination.PageFilter;
import dev.lugami.tails.util.menu.pagination.FilterablePaginatedMenu;
